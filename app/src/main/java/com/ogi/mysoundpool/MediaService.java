...
public class MediaService extends Service implements MediaPlayerCallback{
    ...
    private void init() {
        ...
        AssetFileDescriptor afd = getApplicationContext().getResources().openRawResourceFd(R.raw.tabei_romance_de_amoure);
        try {
    ...
    void showNotif() {
        ...
        String CHANNEL_DEFAULT_IMPORTANCE = "Media Player Testing";
        int ONGOING_NOTIFICATION_ID = 1;
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_DEFAULT_IMPORTANCE)
                .setContentTitle("Guitar Classic")
                .setContentText("Tabei Romance De Amoure")
